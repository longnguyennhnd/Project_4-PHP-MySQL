...
<head>
    ...
    <!-- Vendor styles -->
        ...
        <link rel="stylesheet" href="{{asset('backend/vendors/jqTree/jqtree.css')}}">
...
<body data-ma-theme="blue-grey">
        ...
        <aside class="sidebar">
            <div class="scrollbar-inner">
                ...
                <ul class="navigation">
                    ...
                    <li><a href="{{url('/Account')}}"><i class="zmdi zmdi-accounts-list zmdi-hc-fw"></i> Quản lý Account</a>
                    </li>
    ...
    <script src="{{asset('backend/vendors/jquery/jquery.min.js')}}"></script>
        ...
        <script src="{{asset('backend/vendors/jqTree/tree.jquery.js')}}"></script>
        ...
        <script src="{{asset('backend/demo/js/flot-charts/pie.js')}}"></script>
